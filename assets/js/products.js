...
var products=new Vue({
	...
	methods:{
	    ...
	    body +="<button data-toggle='collapse' data-target='.exfdatadiv' class='btn btn-outline-info  btn-block' style='margin-top:5px;'>"+this.t('Add Sub-Products')+"</button><div class='collapse exfdatadiv' id='subproducts'>"+extras+"</div>";


        body +="<button data-toggle='collapse' data-target='#opproducts' class='btn btn-outline-info  btn-block' style='margin-top:5px;'>"+this.t('Add Optional Products')+"</button><div class='collapse' id='opproducts'>"+extras+"</div>";
...
return Vue.extend({
	...
	methods:{
		...
		var sentdata={"createsaveproduct":1,"productid":this.productid,"title":this.title,"description":this.description,"url":this.url,"price":this.price,"currency":this.currency,"sheeping":this.shipping,"subproducts":subarr.join("@brk@"),"opproducts":oparr.join("@brk@"),"tax":this.tax,"doupdate":this.doupdate};
