...
<html lang="en">
  <head>
	...
	<link href="assets/js/vv/css/line-awesome.css" rel="stylesheet">
...
<body>
	...
	<div id="vvveb-builder">
				...
				<div id="top-panel">
					<img src="assets/img/hover-logo.png" alt="Vvveb" class="float-left" id="logo" style="max-width:80px;margin-left: -20px;">
					...
					<div class="btn-group float-left" role="group">
					  <!-- <button class="btn btn-light" title="Toggle file manager" id="toggle-file-manager-btn" data-vvveb-action="toggleFileManager" data-toggle="button" aria-pressed="false">
						  <img src="assets/js/vv/libs/builder/icons/file-manager-layout.svg" width="20px" height="20px">
					  </button> -->

					  <button class="btn btn-light" title="<?php w("Toggle left column"); ?>" id="toggle-left-column-btn" data-vvveb-action="toggleLeftColumn" data-toggle="button" aria-pressed="false">
						  <img src="assets/js/vv/libs/builder/icons/left-column-layout.svg" width="20px" height="20px">
					  </button>
					  
					  <button class="btn btn-light" title="<?php w("Toggle right column"); ?>" id="toggle-right-column-btn" data-vvveb-action="toggleRightColumn" data-toggle="button" aria-pressed="false">
					...
					<div class="btn-group mr-3" role="group">
					  ...
					  <button class="btn btn-light"  title="<?php w("Redo (Ctrl/Cmd + Shift + Z)"); ?>" id="redo-btn" data-vvveb-action="redo" data-vvveb-shortcut="ctrl+shift+z">
					...
					<div class="btn-group mr-3" role="group">
					  <button class="btn btn-light" title="<?php w("Designer Mode (Free component dragging)"); ?>" id="designer-mode-btn" data-toggle="button" aria-pressed="false" data-vvveb-action="setDesignerMode">
						  <i class="la la-hand-grab-o"></i>
					  </button>

					  <button class="btn btn-light" title="<?php w("Preview"); ?>" id="preview-btn" type="button" data-toggle="button" aria-pressed="false" data-vvveb-action="preview">
						  <i class="la la-eye"></i>
					  </button>

					  <button class="btn btn-light" title="<?php w("Fullscreen (F11)"); ?>" id="fullscreen-btn" data-toggle="button" aria-pressed="false" data-vvveb-action="fullscreen">
					...
					<div class="btn-group mr-3" role="group">
					  <button class="btn btn-light" title="<?php w("Save (Ctrl + E)"); ?>" id="save-btn" data-vvveb-action="saveAjax" data-vvveb-shortcut="ctrl+e">
						  <i class="la la-save"></i>
					  </button>
					  
					  <button class="btn btn-light" title="<?php w("Download"); ?>" id="download-btn" data-vvveb-action="download" data-download="index.html">
...
<!-- /page -->					  
						...
						<div class="header">							
							<ul class="nav nav-tabs" id="elements-tabs" role="tablist">
							  <li class="nav-item component-tab">
								<a class="nav-link active" id="components-tab" data-toggle="tab" href="#components" role="tab" aria-controls="components" aria-selected="true"><i class="la la-lg la-cube"></i> <div><small><?php w("Components"); ?></small></div></a>
							  </li>
							  <li class="nav-item blocks-tab">
								<a class="nav-link" id="blocks-tab" data-toggle="tab" href="#blocks" role="tab" aria-controls="blocks" aria-selected="false"><i class="la la-lg la-image"></i> <div><small><?php w("Blocks"); ?></small></div></a>
							  </li>
							  <li class="nav-item component-properties-tab" style="display:none">
								<a class="nav-link" id="properties-tab" data-toggle="tab" href="#properties" role="tab" aria-controls="blocks" aria-selected="false"><i class="la la-lg la-cog"></i> <div><small><?php w("Properties"); ?></small></div></a>
							  </li>
							</ul>
								   ...
								   <div class="search">
									...
									<div class="drag-elements-sidepane sidepane">
									  <div>
										...
										<center>
										<a onclick="viewTutorial('https://cloudfunnels.in/membership/members#tutorials_editor')" style="cursor:pointer;color: rgb(31, 87, 202);"><i class="fas fa-play"></i>&nbsp;<?php w("Watch Tutorials"); ?></a>
										</center>
									  </div>
									</div>
												...
												<ul class="nav nav-tabs nav-fill" id="properties-tabs" role="tablist">
													  <li class="nav-item content-tab">
														<a class="nav-link active" data-toggle="tab" href="#content-left-panel-tab" role="tab" aria-controls="components" aria-selected="true">
															<i class="la la-lg la-cube"></i> <div><span><?php w("Content"); ?></span></div></a>
													  </li>
													  <li class="nav-item style-tab">
														<a class="nav-link" data-toggle="tab" href="#style-left-panel-tab" role="tab" aria-controls="blocks" aria-selected="false">
															<i class="la la-lg la-image"></i> <div><span><?php w("Style"); ?></span></div></a>
													  </li>
													  <li class="nav-item advanced-tab">
														<a class="nav-link" data-toggle="tab" href="#advanced-left-panel-tab" role="tab" aria-controls="blocks" aria-selected="false">
															<i class="la la-lg la-cog"></i> <div><span><?php w("Advanced"); ?></span></div></a>
													  </li>
													</ul>
													...
													<div class="tab-content">
														 <div class="tab-pane fade show active" id="content-left-panel-tab" data-section="content" role="tabpanel" aria-labelledby="content-tab">
															<div class="mt-4 text-center"><?php w("Click on an element to edit."); ?></div>
														</div>
						...
						<div id="iframe-layer">
							...
							<div id="select-box">
								...
								<div id="wysiwyg-editor">
										<a id="bold-btn" href="" title="<?php w("Bold"); ?>"><i><strong>B</strong></i></a>
										<a id="italic-btn" href="" title="<?php w("Italic"); ?>"><i>I</i></a>
										<a id="underline-btn" href="" title="<?php w("Underline"); ?>"><u>u</u></a>
										<a id="strike-btn" href="" title="<?php w("Strikeout"); ?>"><del>S</del></a>
										<a id="link-btn" href="" title="<?php w("Create link"); ?>"><strong>a</strong></a>
								</div>

								<div id="select-actions">
									<a id="drag-btn" href="" title="<?php w("Drag element"); ?>"><i class="la la-arrows"></i></a>
									<a id="parent-btn" href="" title="<?php w("Select parent"); ?>"><i class="la la-level-down la-rotate-180"></i></a>
							...
							<div id="add-section-box" class="drag-elements">
									...
									<div class="header">							
										<ul class="nav nav-tabs" id="box-elements-tabs" role="tablist">
										  <li class="nav-item component-tab">
											<a class="nav-link active" id="box-components-tab" data-toggle="tab" href="#box-components" role="tab" aria-controls="components" aria-selected="true"><i class="la la-lg la-cube"></i> <div><small><?php w("Components"); ?></small></div></a>
										  </li>
										  <li class="nav-item blocks-tab">
											<a class="nav-link" id="box-blocks-tab" data-toggle="tab" href="#box-blocks" role="tab" aria-controls="blocks" aria-selected="false"><i class="la la-lg la-image"></i> <div><small><?php w("Blocks"); ?></small></div></a>
										  </li>
										  <li class="nav-item component-properties-tab" style="display:none">
											<a class="nav-link" id="box-properties-tab" data-toggle="tab" href="#box-properties" role="tab" aria-controls="blocks" aria-selected="false"><i class="la la-lg la-cog"></i> <div><small><?php w("Properties"); ?></small></div></a>
										  </li>
										</ul>
										...
										<div class="section-box-actions">
											...
											<div class="small mt-1 mr-3 float-right">
												...
												<div class="custom-control custom-radio custom-control-inline">
												  ...
												  <label class="custom-control-label" for="add-section-insert-mode-after"><?php w("After"); ?></label>
												</div>
												
												<div class="custom-control custom-radio custom-control-inline">
												  <input type="radio" id="add-section-insert-mode-inside" value="inside" name="add-section-insert-mode" class="custom-control-input">
												  <label class="custom-control-label" for="add-section-insert-mode-inside"><?php w("Inside"); ?></label>
												</div>
										...
										<div class="tab-content">
										  <div class="tab-pane fade show active" id="box-components" role="tabpanel" aria-labelledby="components-tab">
											   ...
											   <div class="search">
													  <input class="form-control form-control-sm component-search" placeholder="<?php ("Search components"); ?>" type="text" data-vvveb-action="addBoxComponentSearch" data-vvveb-on="keyup">
													  <button class="clear-backspace"  data-vvveb-action="clearComponentSearch">
														  <i class="la la-close"></i>
													  </button>
												  </div>
										  ...
										  <div class="tab-pane fade" id="box-blocks" role="tabpanel" aria-labelledby="blocks-tab">
											   ...
											   <div class="search">
													  <input class="form-control form-control-sm block-search" placeholder="<?php w("Search blocks"); ?>" type="text" data-vvveb-action="addBoxBlockSearch" data-vvveb-on="keyup">
													  <button class="clear-backspace"  data-vvveb-action="clearBlockSearch">
														  <i class="la la-close"></i>
													  </button>
												  </div>
				...
				<div class="btn-group" role="group">
		 			 ...
		 			 <button id="code-editor-btn" data-view="mobile" class="btn btn-sm btn-light btn-sm"  title="<?php w("Code editor") ?>" data-vvveb-action="toggleEditor">
						  <i class="la la-code"></i> <?php w("Code editor"); ?>
					  </button>
						...
						<div id="toggleEditorJsExecute" class="custom-control custom-checkbox mt-1" style="display:none">
							...
							<label class="custom-control-label" for="customCheck"><small><?php w("Run javascript code on edit"); ?></small></label>
						</div>
					</div>
...
<script>
	...
	?>
	const cf_global_img_upload_info={imgstore:1,upload_location:"<?php echo str_replace('@folder@',$_GET['folder'],$content['img_dir']); ?>",img_base_url:"<?php echo str_replace('@folder@',$_GET['folder'],$content['img_url']);?>"};
</script>
...
<!-- components-->
<script src="assets/js/vv/libs/builder/components-server.js"></script>	
...
<script src="assets/js/vv/assets/js/vv/libs/autocomplete/jquery.autocomplete.js"></script>	
...
<style>
	...
	div#add-section-box .components-list 
	{
