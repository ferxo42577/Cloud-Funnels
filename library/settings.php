...
class Settings
{
    ...
    function saveSettings()
    {
		...
		if(isset($_POST['self_gcp_bucket']))
		{
			$self_gcp_bucket=$mysqli->real_escape_string($_POST['self_gcp_bucket']);
		}
		...
		if(isset($_FILES['default_404_page_logo']) && (strlen($_FILES['default_404_page_logo']['name'])>0))
		{
			...
			$dirtomoveuplodaedimage=($is_gcp)? $gcp_bucket."/qfnl_project_assets/img/404/404-logo.".$invalid_extension_name:$this->base_dir."/assets/img/404-logo.".$invalid_extension_name;

			$urlfor404page=($is_gcp)? $gcp_bucket_url."/qfnl_project_assets/img/404/404-logo.".$invalid_extension_name:get_option('install_url')."/assets/img/404-logo.".$invalid_extension_name;
		...
		if(isset($self_gcp_bucket))
		{
			update_option('self_gcp_bucket',$self_gcp_bucket);
		}
