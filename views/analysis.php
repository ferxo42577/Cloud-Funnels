    ...
    <div class="col-sm-12">
      ...
      <input type="hidden" name="page" value="analysis">
        <div class="form-group">
          <label for="exampleFormControlSelect1"><?php w('Select funnel which you want to analyze'); ?></label>
          <select class="btn  form-control" id="exampleFormControlSelect1" name="analysis_funnel" onchange="if(this.value>0){this.form.submit();}"  >
...
<?php echo createSearchBoxBydate(); ?>
 ...
 if (isset($_GET['analysis_funnel'])) {
    ...
    $id=0;$type="";$funnel_title="Funnel NOt Found";$funnel_baseurl="";
...
<!--start--><div class="row pagestatall" id="detail-page-<?php echo $res['id']; ?>">
...
<style type="text/css">
  ...
  .cover-div:hover,.cover-btn:hover
  {
    opacity:1 !important;
  }
