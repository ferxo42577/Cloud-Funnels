      ...
      <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
              ...
              <div class="dropdown">
                <button type="button" class="btn dropdown-toggle btn-block" id="drpdwnstyle" data-toggle="dropdown">
                ...
                <div id="permissiondiv" class="dropdown-menu btn-block" style="max-height: 350px;overflow-y: auto;">
                  ...
                  <div style="padding: 0px 10px 0px 10px;width: 500px;">
                    ...
                    <label>&nbsp;<input type="checkbox" name="permission[]" class="checkstyle" value="payment_records,payment_methods" <?php if (in_array('payment_records', $permission)) {echo "checked";} ?>><?php w("Payment Methods"); ?></label>

                    <label>&nbsp;<input type="checkbox" name="permission[]" class="checkstyle" value="autores_records,autores_dashboard" <?php if (in_array('autores_records', $permission)) {echo "checked";} ?>><?php w("Autoresponders"); ?></label>

                    <label>&nbsp;<input type="checkbox" name="permission[]" class="checkstyle" value="integrations" <?php if (in_array('integrations', $permission)) {echo "checked";} ?>><?php w("Integrations"); ?></label>
                    ...
                    <label>&nbsp;<input type="checkbox" name="permission[]" class="checkstyle"                       value="zapier_integration" <?php if (in_array('zapier_integration', $permission)) {echo "checked";
                    } ?>><?php w("Zapier Integrations"); ?></label>
              ...
              <div class="form-group" data-toggle="tooltip" title="<?php w("Please provide your current password to create a new user or to Modify existing user's credentials"); ?>">
              ...
              <center><p id="user-err-msg" class='<?php echo (isset($GLOBALS['user_addorupdate_err']))? "text-danger":"text-success"; ?>'><?php if(isset($GLOBALS['user_addorupdate_err'])){echo "<strong>".t("Unable to save settings, may be another user with same email exists or signature password is wrong.")."</strong>";}elseif(isset($_POST["save"])){echo "<strong>".t("Data Saved Successfully")."</strong>";} ?></p></center>
