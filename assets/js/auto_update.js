function qfnlAutoUpdate()
{
    ...
    this.doInstall=function(){
        var thiss=this;
        //alert('checkforqfnl_update=install&checkforqfnl_update_version='+this.version);
    ...
    this.showUpdateBox=function(version,changes)
    {
        ...
        else if(this.is_self_hosted_gcp)
        {
            var install_button=`<a href="http://cloudfunnels.in/membership/members/#google_cloud_public" target="_BLANK"><button class="btn btn-success btn-block">Update&nbsp;From&nbsp;Membership</button></a>`;
        }
        else
        {
        ...
        var html=`<div class="card">
                    ...
                    <div class="card-body">
                        <a href="#" data-toggle="collapse" data-target="#upwhatsnewdetail"><strong>Whats New In This Version?</strong></a><p id="upwhatsnewdetail" class="collapse">${this.changes}</p>
                    </div>
