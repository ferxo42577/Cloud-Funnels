...
{
    if($_SESSION['order_form_data'.get_option('site_token')])
    {
...
function add_to_list($list_id,$data)
{
    //list_id
    /*
    array('name','email','additional_data','process_sequence')
    */
    $plugin_loader=$GLOBALS['plugin_loader'];
...
{
    //subscriber id
    //array('name','email','additional_data'
    $plugin_loader=$GLOBALS['plugin_loader'];
