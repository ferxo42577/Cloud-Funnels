...
var authcreate=new Vue(
{
	...
	createConfig:function(e){
		...
		{
		var data={"createconfig":1,"host":this.host,"user":this.user,"pass":this.pass,"dbname":this.db,"port":this.port,"gcp_instance":this.gcp_instance,"pref":this.prefix,"token":this.csrfval};
	...
	createUser:function(e){
		...
		var thisvue=this;
		this.err="";
		var data={"createuser":1,"user-name":this.username,"user-email":this.email,"user-pass":this.userpass,"self_gcp_bucket":this.self_gcp_bucket,"token":this.csrfval,"app_language":this.current_language};
