...
<center><strong><p id="err"><?php if($err==1){echo "<font color='green'>Your Request Submitted Successfully</font>";}elseif(!is_numeric($err)){echo "<font color='#e6005c'>".$err."</font>";} ?></p></strong></center>
